# -*- coding: utf-8 -*-
"""
Created on Mon Oct 18 23:21:10 2021
...
#Colour picking with HSV value sliders
...
while True:
    ...
    cv2.imshow('Trackbars',cv2.resize(stacked,None,fx=0.5,fy=0.5)) # (original, desired size, scale along x axis, y)
